...
* RMarkdown and publication-ready documents by **Anna Quaglieri** and **[Soroor Hediyeh Zadeh](https://twitter.com/SoroorHediyeh?s=20)** in Feb
*	Overview of Reproducible research, documentation, and cloud computing by **[Lavinia Gordon](https://twitter.com/MrsLaviniaG?s=20)** in May
*	Natural language processing from **Ana Mamatelashvili** in Jun
*	Package review system and rOpenSci from **[Melina Vidoni](https://twitter.com/melvidoni?s=20)** in Jul
*	Reproducibility using Containers in R by **[Saras Windecker](https://twitter.com/smwindecker?s=20)** in Sep
...
# Aknowledgements
I would like to thank Marie, Goknur, Anna, and Sehrish for their valuable feedback about this document. Also, thanks to Anna for her great reports last year, which were useful to produce this document. Finally, I would like to thank [Ramyar Molania](https://twitter.com/RamyarMolania) for his ongoing support for my R-Ladies activities!
